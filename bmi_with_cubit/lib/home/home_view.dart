...
import 'package:bmi_with_cubit/widgets/bottom_navigation_button.dart';
import 'package:bmi_with_cubit/widgets/gender_card.dart';
import 'package:bmi_with_cubit/widgets/height_card.dart';
import 'package:bmi_with_cubit/widgets/remove_card.dart';
                  ...
                  child: BlocBuilder<BmiCubit, BmiState>(
                    builder: (context, state) {
                      return GenderCard(
                        ...
                        onTap: () =>
                            context.read<BmiCubit>().changeGender(true),
                      );
                    },
                  ),
                ),
                  ...
                  child: BlocBuilder<BmiCubit, BmiState>(
                    builder: (context, state) {
                      return GenderCard(
                        ...
                        isActive: !state.isMale,
                        onTap: () =>
                            context.read<BmiCubit>().changeGender(false),
                      );
                    },
                  ),
                ),
                  ...
                  child: BlocBuilder<BmiCubit, BmiState>(
                    builder: (context, state) {
                      return RemoveAddCard(
                        ...
                        onPressedAdd: () =>
                            context.read<BmiCubit>().icrementWeight(),
                      );
                    },
                  ),
                ),
